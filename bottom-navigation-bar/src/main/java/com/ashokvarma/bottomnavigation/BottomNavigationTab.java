...
public abstract class BottomNavigationTab extends FrameLayout {
    ...
    public void select(boolean setActiveColor, int animationDuration, boolean FixedisStartAnimator) {
        isActive = true;
        if (FixedisStartAnimator) {
    ...
    public void unSelect(boolean setActiveColor, int animationDuration, boolean FixedisStartAnimator) {
        isActive = false;
        if (FixedisStartAnimator) {
