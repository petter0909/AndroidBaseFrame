...
public class FixedBottomNavigationTab extends BottomNavigationTab {
    ...
    @Override
    public void select(boolean setActiveColor, int animationDuration,boolean isStartAnimator) {
        if (isStartAnimator)
...
//        labelView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.fixed_label_active));
        super.select(setActiveColor, animationDuration,isStartAnimator);
    }

    @Override
    public void unSelect(boolean setActiveColor, int animationDuration,boolean isStartAnimator) {
        if (isStartAnimator)
...
//        labelView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.fixed_label_inactive));
        super.unSelect(setActiveColor, animationDuration,isStartAnimator);
    }
