	...
	public static List<ContactItemInterface> getSampleContactList(boolean buxian)
	{
		...
		try
		{
			...
			for(int i = 0; i < ja1.length(); i++)
			{
				...
				list.add((ContactItemInterface) new CityItem(cityName, PinYin.getPinYin(cityName)));
			}
		} 
