package com.third.party.library.views.XTabLayout;
        ...
        post(new Runnable() {
            ...
            public void run() {
                if (dividerWidth > 0) {
                    ...
                    dividerDrawable.setBackgroundColor(xTabBackgroundColor);
...
//        invalidate();
     ...
     */
    public void setDividerDrawable(int dividerVertical) {
        LinearLayout linearLayout = (LinearLayout) this.getChildAt(0);
        linearLayout.setShowDividers(LinearLayout.SHOW_DIVIDER_MIDDLE);
        linearLayout.setDividerDrawable(ContextCompat.getDrawable(getContext(), dividerVertical));
    }
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    public interface OnViewPagerChangedListener{
        void doViewPageronChanged();
    }

    private static OnViewPagerChangedListener onViewPagerChangedListener ;

    public void setOnViewPagerChangedListener(OnViewPagerChangedListener onViewPagerChangedListener){
        this.onViewPagerChangedListener=onViewPagerChangedListener;
    }

    private static void doViewPageronChanged(){
        if (onViewPagerChangedListener!=null){
            onViewPagerChangedListener.doViewPageronChanged();
        }
    }
