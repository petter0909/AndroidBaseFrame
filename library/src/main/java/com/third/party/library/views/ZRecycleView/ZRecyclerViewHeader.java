...
//    private RotateAnimation refreshingAnimation;
    ...
    private void initView(Context context) {
        ...
        // 初始情况，设置下拉刷新view高度为0
        mContainer= (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.xrecyclerview_refresh_head,null);
        progressbar = (ProgressBar) mContainer.findViewById(R.id.xlistview_header_progressbar);
...
//                    mArrowImageView.clearAnimation();
//                }
//                mStatusTextView.setText(R.string.xlistview_header_hint_normal);
//                break;
//            case STATE_RELEASE_TO_REFRESH:
//                if (mState!=STATE_RELEASE_TO_REFRESH){
//                    mArrowImageView.clearAnimation();
//                    mArrowImageView.startAnimation(mRotateUpAnim);
//                    mStatusTextView.setText(R.string.xlistview_header_hint_ready);
//                }
//                break;
//            case STATE_REFRESHING:
//                mProgressBar.startAnimation(refreshingAnimation);
//                mStatusTextView.setText(R.string.xlistview_header_hint_loading);
//                break;
//            default:
//                break;
//        }
