...
public class PickerView extends View
{
	...
	private void init()
	{
		...
		mPaint.setColor(getResources().getColor(R.color.text_color_333333));
	}
	...
	private void drawData(Canvas canvas)
	{
		...
		//canvas.drawLine(0, baseline + 2, mViewWidth, baseline + 2, mPaint);
		LogUtils.e("drawData", baseline + "");
		// 绘制上方data
	...
	private void drawOtherText(Canvas canvas, int position, int type)
	{
		...
		mPaint.setStrokeWidth((float) 1.0);
		//canvas.drawLine(0, baseline + 2, mViewWidth, baseline + 2, mPaint);
		LogUtils.e("drawOtherText", baseline+"");
	}
