...
final class SmoothScrollTimerTask_WatchType extends TimerTask {
    ...
    SmoothScrollTimerTask_WatchType(WheelView_WatchType loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            if(loopView.handler!=null) {
                loopView.handler.sendEmptyMessage(MessageHandler_WatchType.WHAT_ITEM_SELECTED);
            }
        } else {
            ...
            if(loopView.handler!=null) {
                loopView.handler.sendEmptyMessage(MessageHandler_WatchType.WHAT_INVALIDATE_LOOP_VIEW);
            }
