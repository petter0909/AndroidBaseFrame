...
public class IntentUtils {
    ...
    public void startActivity(final Activity context, final Intent intent) {
        final View v = context.findViewById(android.R.id.content);
    ...
    public void startActivityForResult(final Activity context, final Intent intent, final int requestCode) {
        final View v = context.findViewById(android.R.id.content);
