...
import com.third.party.library.utils.GlideUtil;
...
public abstract class BaseRvAdapter<T> extends RecyclerView.Adapter<BaseRvAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        initData(holder, mDatas.get(position));
    }

    public abstract void initData(ViewHolder holder, T t);
    ...
    public void removeDataformPos(int positon) {
        if (this.mDatas != null) {
            this.mDatas.remove(positon);
        }
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        {
            ImageView view = getView(viewId);
            GlideUtil.loadF(mContext,url,view);
            return this;
        }
